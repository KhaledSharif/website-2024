...
import FeaturesElement4 from "@/public/images/gs-slam.jpg";
import FeaturesElement5 from "@/public/images/mgs-slam.jpg";
import FeaturesElement6 from "@/public/images/amos-slam.jpg";
              ...
              <Card className="pt-4">
                ...
                <CardContent>
                  ...
                  <div className="flex w-full items-center justify-center pt-32">
                    <Image src={FeaturesElement4} alt="robots" />
                  </div>
                  <div className="markdown">
                  ...
                  <div className="flex w-full items-center justify-center pt-32">
                    <Image src={FeaturesElement5} alt="robots" />
                  </div>
                  <div className="markdown">
                  ...
                  <div className="flex w-full items-center justify-center pt-32">
                    <Image src={FeaturesElement6} alt="robots" />
                  </div>
                  <div className="markdown">
                    <Markdown>{md4}</Markdown>
                  </div>
                </CardContent>
              </Card>
            </div>
